...
uint8_t networkKey[] = {0x95,0x75,0xA4,0xDD,0x02,0xA6,0x87,0x39,0xCA,0x6F,0x0A,0xB7,0x44,0x99,0x42,0x75};
uint8_t applicationKey[] = {0xAA,0x36,0x40,0xAB,0x0E,0x47,0xDF,0x96,0x06,0x55,0x79,0xA4,0x96,0x16,0x4C,0x56};
